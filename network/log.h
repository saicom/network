...
#define CnWarn LOG_WARN
#define CnDbg LOG_WARN
#define CnError LOG_WARN
#define CnFatal LOG_FATAL

#define CnAssert assert

#define LOG_HEX(data, len, level) utils::Log::global_log.log_hex((unsigned char *)(data), (len), (level))
#define LOG_HEX_PREFIX(prefix, data, len, level) utils::Log::global_log.log_hex_prefix((unsigned char *)(prefix), (unsigned char *)(data), (len), (level))
