...
//! @brief 网络包最大长度
//!
//! 目前系统使用的包大小都不超过65535, 此处包数据缓存大小设为65535,
//! 开发新协议时注意包长度不要超过此处限制
#ifndef MAX_PACKET_LENGTH
#define MAX_PACKET_LENGTH (32 * 1024)//65535
#endif
